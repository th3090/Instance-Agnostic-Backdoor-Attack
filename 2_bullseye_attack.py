...
def main():
    ...
    save_path = './dataset/Training_105/Z_Taehoon2'
    ...
    attack_modes = 'bullseye_convex_polytope'
    ...
    if attack_modes == 'bullseye_convex_polytope':
    ...
    # Training
    remove_list = ["Z_Taehoon1", "Z_Taehoon3", "Z_Taehoon4"]
